...
/**
 * Strings for component 'theme_kitty', language 'en'
 *
 * @package   theme_kitty
...
<div class="well">
<h2>kitty</h2>
<p><img class="img-polaroid "src="kitty/pix/screenshot.jpg" /></p>
</div>
<div class="well">
<h3>About</h3>
<p>kitty is a modified Moodle bootstrap theme which inherits styles and renderers from its parent theme.</p>
<h3>Parents</h3>
...
<p><a href="kitty/README.txt">How to copy and customise this theme.</a></p>
</div></div>';

$string['configtitle'] = 'kitty';
...
$string['pluginname'] = 'kitty';
$string['privacy:metadata'] = 'The kitty theme does not store any personal data about any user.';
